                ...
                <div class="card border border-0" style="background: none; width: 22rem;">
                    <div class="card-body text-center">
                        <div class="d-flex justify-content-center">
                            ...
                            src="<?php echo get_stylesheet_directory_uri();?>/images/profielfoto-cartoon_HV.png" alt="profielfoto">
                        ...
                        <div class="card-text p-3" style="background-color:#F8F8F8;">
                            ...
                            <div class="my-3" aria-current="true">
                                <div class="d-flex w-100 justify-content-start">
                                    <h6 class="mb-1 w-50 text-start">Specialisatie 1:</h6>
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination">
                        ...
                        <a class="page-link" href="#" aria-label="Previous">
                            <span aria-hidden="true"><i class="fa-solid fa-arrow-left text-dark"></i></span>
                        </a>
                        </li>
                        <li class="page-item">
                        <a class="page-link" href="#" aria-label="Next">
                            <span aria-hidden="true"><i class="fa-solid fa-arrow-right text-dark"></i></span>
                        </a>
                        </li>
                    </ul>
                    </nav>
